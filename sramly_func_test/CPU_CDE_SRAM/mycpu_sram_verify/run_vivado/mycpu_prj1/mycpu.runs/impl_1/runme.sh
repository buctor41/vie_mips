...
HD_PWD='F:/loogson/vie_mips/sramly_func_test/CPU_CDE_SRAM/mycpu_sram_verify/run_vivado/mycpu_prj1/mycpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_sram_lite_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soc_sram_lite_top.tcl -notrace
