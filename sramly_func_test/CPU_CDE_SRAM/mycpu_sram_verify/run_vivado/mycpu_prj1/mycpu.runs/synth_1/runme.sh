...
HD_PWD='F:/loogson/vie_mips/sramly_func_test/CPU_CDE_SRAM/mycpu_sram_verify/run_vivado/mycpu_prj1/mycpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_sram_lite_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_sram_lite_top.tcl
