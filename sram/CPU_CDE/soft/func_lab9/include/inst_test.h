...
/* 63 */
#define TEST_LWL(init_data, data, base_addr, offset, offset_align, ref) \
    LI (t1, data); \
    LI (t0, base_addr); \
    LI (v0, init_data); \
    LI (v1, ref); \
...
/* 64 */
#define TEST_LWR(init_data, data, base_addr, offset, offset_align, ref) \
    LI (t1, data); \
    LI (t0, base_addr); \
    LI (v0, init_data); \
    LI (v1, ref); \
...
/* 67 */
#define TEST_SWL(init_data, data, base_addr, offset, offset_align, ref) \
    LI (t2, init_data); \
    LI (t1, data); \
    LI (t0, base_addr); \
    LI (v1, ref); \
...
/* 68 */
#define TEST_SWR(init_data, data, base_addr, offset, offset_align, ref) \
    LI (t2, init_data); \
    LI (t1, data); \
    LI (t0, base_addr); \
    LI (v1, ref); \
...
/*81*/
#define TEST_TI_EX(time_s,time_e) \
    li   a3, 0x0040ff01; \
    li   v1, time_e; \
    addiu v0, v1, 10; \
    mtc0 v0, c0_count; \
