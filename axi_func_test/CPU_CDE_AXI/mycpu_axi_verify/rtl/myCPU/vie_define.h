...
//fsm0
`define RR_IDLE         3'b001
`define RR_WAIT         3'b010 
`define RR_END          3'b100 



`define WR_IDLE         5'b00001
`define WR_WAIT_ADDR    5'b00010 
`define WR_WDATA        5'b00100
`define WR_WAIT_DATA    5'b01000 
`define WR_END          5'b10000 